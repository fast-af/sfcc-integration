...
tmpl.innerHTML = `
  ...
  <div class="backdrop">
    <div class="message">
      ...
      <div>
        <p>No longer see the Fast window?</p>
        <p>
          <a
            class="focusTrigger"
          >
...
export const FastBackdrop = class extends HTMLElement {
  constructor() {
    super();
    ...
    const focusTrigger = shadowRoot.querySelector(".focusTrigger");
    focusTrigger?.addEventListener("click", () => {
      this.dispatchEvent(new Event("focus-click"));
    });
  }
};
