// To parse this data:
//
//   import { ConvertUpdateResponse, UpdateOrderResponse } from "./file";
//
//   const updateOrderResponse = ConvertUpdateResponse.toUpdateOrderResponse(json);
//
...
export interface UpdateOrderResponseOrder {
  order?: OrderOrder;
  status?: Status[];
}
...
// ConvertUpdateResponses JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export class ConvertUpdateResponse {
  public static toUpdateOrderResponse(json: string): UpdateOrderResponse {
    return cast(JSON.parse(json), r("UpdateOrderResponse"));
  }

  public static updateOrderResponseToJson(value: UpdateOrderResponse): string {
    return JSON.stringify(uncast(value, r("UpdateOrderResponse")), null, 2);
  }
}
...
const typeMap: any = {
  UpdateOrderResponse: o(
    [
      ...
      { json: "type", js: "type", typ: u(undefined, "") },
      {
        json: "order",
        js: "order",
        typ: u(undefined, r("UpdateOrderResponseOrder")),
      },
    ],
    false
  ),
  UpdateOrderResponseOrder: o(
    [
  ...
  Status: o(
    [
      ...
      { json: "reason_code", js: "reason_code", typ: u(undefined, "") },
