// To parse this data:
//
//   import { ConvertCreateResponse, CreateOrderResponse } from "./file";
//
//   const createOrderResponse = ConvertCreateResponse.toCreateOrderResponse(json);
//
...
export interface CreateOrderResponse {
  type?: string;
  order?: CreateOrderResponseOrder;
  request_id?: RequestID;
  user?: CreateOrderResponseUser;
  webhook?: CreateOrderResponseWebhook;
}
...
export interface CreateOrderResponseUser {
  user?: UserUser;
}
...
export interface CreateOrderResponseWebhook {
...
// ConvertCreateResponses JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export class ConvertCreateResponse {
  public static toCreateOrderResponse(json: string): CreateOrderResponse {
    return cast(JSON.parse(json), r("CreateOrderResponse"));
  }

  public static createOrderResponseToJson(value: CreateOrderResponse): string {
    return JSON.stringify(uncast(value, r("CreateOrderResponse")), null, 2);
  }
}
...
const typeMap: any = {
  CreateOrderResponse: o(
    [
      { json: "type", js: "type", typ: u(undefined, "") },
      {
        json: "order",
        js: "order",
        typ: u(undefined, r("CreateOrderResponseOrder")),
      },
      {
        json: "request_id",
        js: "request_id",
      ...
      },
      {
        json: "user",
        js: "user",
        typ: u(undefined, r("CreateOrderResponseUser")),
      },
      {
        json: "webhook",
        js: "webhook",
        typ: u(undefined, r("CreateOrderResponseWebhook")),
      },
    ],
    false
  ),
  CreateOrderResponseOrder: o(
